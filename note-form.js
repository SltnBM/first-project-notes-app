import { customValidationTitleHandler, customValidationBodyHandler } from './form-custom-validation.js';
...
class NoteForm extends HTMLElement {
    ...
    `;
        ...
        const fields = [
            { el: form.elements.title, handler: customValidationTitleHandler, count: form.querySelector('#titleCount'), error: form.querySelector('#titleError') },
            { el: form.elements.body, handler: customValidationBodyHandler, count: form.querySelector('#bodyCount'), error: form.querySelector('#bodyError') }
        ];
